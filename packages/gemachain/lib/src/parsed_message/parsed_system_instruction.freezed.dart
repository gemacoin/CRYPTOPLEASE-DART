...
mixin _$ParsedSystemTransferInformation {
  int get carats => throw _privateConstructorUsedError;
...
abstract class $ParsedSystemTransferInformationCopyWith<$Res> {
  ...
  $Res call({int carats, String source, String destination});
}
...
class _$ParsedSystemTransferInformationCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? carats = freezed,
    Object? source = freezed,
    Object? destination = freezed,
  }) {
    return _then(_value.copyWith(
      carats: carats == freezed
          ? _value.carats
          : carats // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$_ParsedSystemTransferInformation
  ...
  @override
  String toString() {
    return 'ParsedSystemTransferInformation(carats: $carats, source: $source, destination: $destination)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _ParsedSystemTransferInformation &&
            (identical(other.carats, carats) ||
                const DeepCollectionEquality()
                    .equals(other.carats, carats)) &&
  ...
  int get hashCode =>
      runtimeType.hashCode ^
      const DeepCollectionEquality().hash(carats) ^
